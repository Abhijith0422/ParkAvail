...
import 'package:book_my_park/presentation/onbooking.dart';

class BookingView extends StatelessWidget {
  final int index;
  BookingView({super.key, required this.index});
          ...
          children: [
            ...
            Expanded(
              child: GridView.builder(
                itemCount: state.parkdata[index].tslot,
